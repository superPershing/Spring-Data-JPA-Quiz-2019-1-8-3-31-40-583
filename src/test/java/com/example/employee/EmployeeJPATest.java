...
public class EmployeeJPATest {
    ...
    public void setUp() throws Exception {
        ...
        flyway.setDataSource("jdbc:mysql://localhost:3306/employee_db", "root", "mysql");
        flyway.clean();
        flyway.migrate();
    }
    ...
    public void should_return_employee_when_input_employee_name() throws Exception {
        //1.查询名字是小红的employee
        Employee expectedEmployee = new Employee((long) 1, "xiaohong", 19, "female", (long) 1, 7000);
    ...
    public void should_return_employee_given_character_in_name_and_salary_large_than() throws Exception {
        ...
        Employee expectedEmployee = new Employee((long) 1, "xiaoming", 19, "female", (long) 1, 7000);
    ...
    public void should_return_employee_name_when_employee_salary_is_max_and_given_company_id_() throws Exception {
        ...
        Employee expectedEmployee = new Employee((long) 1, "xiaohong", 19, "female", (long) 1, 7000);
        String actualName = employeeRepository.findFirstByCompanyIdOrderBySalaryDesc((long) 1).getName();
        assertThat(actualName).isEqualTo(expectedEmployee.getName());
    }
    ...
    public void should_return_company_name_when_input_employee_name() throws Exception {
        ...
        String actualCompanyName = employeeRepository.findCompanyByEmployeeName("xiaohong").getCompanyName();
